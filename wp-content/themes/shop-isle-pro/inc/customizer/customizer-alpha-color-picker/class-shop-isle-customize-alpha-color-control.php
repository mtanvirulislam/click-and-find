...
/**
 * Class Shop_Isle_Customize_Alpha_Color_Control
 */
class Shop_Isle_Customize_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			get_stylesheet_directory_uri() . '/inc/customizer/customizer-alpha-color-picker/js/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			get_stylesheet_directory_uri() . '/inc/customizer/customizer-alpha-color-picker/css/alpha-color-picker.css',
