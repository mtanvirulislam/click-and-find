...
function shop_isle_about_us_page_customize_register( $wp_customize ) {
	...
	if ( class_exists( 'WP_Customize_Panel' ) ) :
		...
		$wp_customize->add_section(
			'shop_isle_about_page_section', array(
	...
	$wp_customize->add_control(
		new Shop_Isle_Repeater_Controler(
			$wp_customize, 'shop_isle_team_members', array(
	...
	$wp_customize->add_section(
		'shop_isle_aboutus_page_instructions', array(
			'title'    => __( 'About us page', 'shop-isle' ),
			'priority' => 98,
		)
	);
	...
	$wp_customize->add_control(
		new ShopIsle_Aboutus_Page_Instructions(
			$wp_customize, 'shop_isle_aboutus_page_instructions', array(
	...
	if ( class_exists( 'WP_Customize_Panel' ) ) :
		...
		$wp_customize->add_section(
			'shop_isle_about_page_video_section', array(
	...
	/* Video background */
	$wp_customize->add_setting(
		'shop_isle_about_page_video_background', array(
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			$wp_customize, 'shop_isle_about_page_video_background', array(
	...
	/* Video link */
	$wp_customize->add_setting(
		'shop_isle_about_page_video_link', array(
			'sanitize_callback' => 'shop_isle_sanitize_text',
			'transport'         => 'postMessage',
		)
	);
	...
	if ( class_exists( 'WP_Customize_Panel' ) ) :
		...
		$wp_customize->add_section(
			'shop_isle_about_page_advantages_section', array(
	...
	$wp_customize->add_control(
		new Shop_Isle_Repeater_Controler(
			$wp_customize, 'shop_isle_advantages', array(
