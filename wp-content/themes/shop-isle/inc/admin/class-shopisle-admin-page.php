...
class Shopisle_Admin_Page {
				...
				'content' => array(
					...
					array(
						...
						'button' => array(
							...
							'link'      => apply_filters( 'shop-isle-documentation-link', 'https://docs.themeisle.com/article/421-shop-isle-documentation-wordpress-org' ),
							'is_button' => false,
							'blank'     => true,
						),
					),
	...
	public function free_pro_render() {
		$free_pro = array(
			...
			'pro_theme_link'      => apply_filters( 'shop_isle_upgrade_link_from_child_theme_filter', 'https://themeisle.com/themes/shop-isle-pro/upgrade/' ),
			/* translators: s - theme name */
	...
	public function welcome_notice_content() {
		...
		$content = sprintf(
			...
			sprintf(
				esc_html__( 'Congratulations!', 'shop-isle' ),
				$name
			),
			sprintf(
				/* translators: %s - theme name */
			...
			$ob_btn,
			esc_html__( 'Return to your dashboard', 'shop-isle' )
		);
